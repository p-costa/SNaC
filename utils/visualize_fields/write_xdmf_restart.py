...
for iblock in range(1,nblocks+1):
    ...
    #
    filenames = input("Name of the pattern of the restart files to be visualzied [fld*"+blockname+".bin]: ") or "fld*"+blockname+".bin"
    ...
    gridname  = input("Name to be appended to the grid files to prevent overwriting [_fld"+blockname+"]: ") or "_fld"+blockname
    ...
    #
    outfile = input("Name of the output file [viewfld_DNS_fld"+blockname+".xmf]: ") or "viewfld_DNS_fld"+blockname+".xmf"
